<div wire:ignore.self class="modal fade" id="addPo" tabindex="-1" aria-labelledby="addPoLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="addPoLabel">Create New Purchase Order</h5>
        ...
        <div class="modal-body">
            <div class="bg-light rounded h-100 p-4">
                <form>
                  ...
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" placeholder="Purchase Order Date" id="datepicker-po" name="date_of_purchase_order" wire:model.defer="date_of_purchase_order" value=1></p>
                    <label for="floatingInput">Purchase Order Date</label>
                    @error('purchase_order_date') <span class="text-danger">{{$message}}</span> @enderror
                  </div>
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" placeholder="Date Needed" id="datepicker-po-needed" name="date_needed" wire:model.defer="date_needed" value=1></p>
                  ...
                  <div class="form-floating mb-3"">
                    <button type="submit" class="btn btn-primary" wire:click.prevent="store()">Add Purchase Order</button>
                  </div>
                </form>
            </div>
        </div>
    ...
    <script>
          ...
          // });
      $( function() {
        $( "#datepicker-po" ).datepicker({ dateFormat: 'yy-mm-dd' });
        $( "#datepicker-po-needed" ).datepicker({ dateFormat: 'yy-mm-dd' });

        $('#datepicker-po').on('change', function (e) {
