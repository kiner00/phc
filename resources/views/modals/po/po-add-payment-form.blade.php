<div wire:ignore.self class="modal fade" id="addPoPayment" tabindex="-1" aria-labelledby="addPoPaymentLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="addPoPaymentLabel">Create New Purchase Order</h5>
        ...
        <div class="modal-body">
            <div class="bg-light rounded h-100 p-4">
                <form>
                  ...
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" placeholder="Purchase Order Date" id="date-of-payment" name="date_of_payment" wire:model.defer="date_of_payment" value=1></p>
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-primary" wire:click.prevent="store()">Add Purchase Order Payment</button>
    ...
    <script>
          ...
          // });
          $( function() {
            $( "#date-of-payment" ).datepicker({ dateFormat: 'yy-mm-dd' });
            $('#date-of-payment').on('change', function (e) {
