<div wire:ignore.self class="modal fade" id="editDelivered" tabindex="-1" aria-labelledby="editDeliveredLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="editDeliveredLabel">Add Delivered Product</h5>
        ...
        <div class="modal-body">
            <div class="bg-light rounded h-100 p-4">
                  <input type="hidden" name="id" wire-model="ids" />
                    ...
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" placeholder="Quantity" name="quantity" wire:model="quantity"/>
