<div wire:ignore.self class="modal fade" id="editManualStock" tabindex="-1" aria-labelledby="editManualStockLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="editManualStockLabel">Edit Stock</h5>
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-primary" wire:click.prevent="update()">Update Manual Product Stock</button>
